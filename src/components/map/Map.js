...
class BaseMap extends Component {
  ...
  render() {
    ...
    return ( 
      ...
      <TileLayer url = 'https://api.mapbox.com/styles/v1/mapbox/streets-v10/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZmRlbWFydGhvbiIsImEiOiJjaXFqdzR3bmcwMDAzaHNtYjVtaDB2N2k2In0.66xu0WI-Ufmhd9zF0uqQLQ'
